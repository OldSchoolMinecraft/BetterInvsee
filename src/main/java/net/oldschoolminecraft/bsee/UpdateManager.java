...
public class UpdateManager
{
    ...
    public UpdateManager(Plugin plugin, String apiUrl)
    {
        this.plugin = plugin;
        this.apiUrl = apiUrl;
    ...
    public void checkForUpdates()
    {
        try
        {
            ...
            if (updateData == null || updateData.has("error"))
            {
    ...
    private void downloadUpdate(String fileURL)
    {
        try
        {
            ...
            Path updateFile = updateFolder.resolve(Objects.requireNonNull(getPluginFile()).getName());
